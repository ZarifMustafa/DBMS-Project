...
$query = "CREATE OR REPLACE VIEW owner_hall_view AS
           SELECT
            hall.hall_id AS \"Hall ID\",
            INITCAP(hall_name) AS \"Hall Name\",
            hall_house_no || ', ' || hall_street || ', ' || hall_city AS \"Address\",
            hall_capacity AS \"Capacity\",
            LISTAGG(time_slot, ', ') WITHIN GROUP (ORDER BY time_slot) AS \"Time_Slots\",
            hall_cost AS \"Cost\"
        FROM owner
        JOIN owns ON owner.owner_id = owns.owner_id
        JOIN hall ON owns.hall_id = hall.hall_id
        JOIN hall_time_slot ON hall.hall_id = hall_time_slot.hall_id
...
$query = "SELECT * FROM owner_hall_view";
$statement = oci_parse($conn, $query);
oci_execute($statement);

$rows = oci_fetch_all($statement, $data, null, null, OCI_FETCHSTATEMENT_BY_ROW);
...
<head>
    ...
    <style>
        ...
        th {
            background-color: #FDAE5F;
        }
        
        tr:nth-child(odd) {
            background-color: #FED0A2;
        }
                    ...
                    <div class="collapse navbar-collapse" id="fablesNavDropdown">
                        <ul class="navbar-nav mx-auto fables-nav">
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="Owner.html" id="sub-nav1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Home
                                </a>
                            </li>
...
<div class="fables-header fables-after-overlay" style="background-image: url(assets/custom/images/index1bg.jpg);">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Hall View</h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <div class="container"> 
        <nav aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            ...
            <li class="breadcrumb-item active" aria-current="page">Hall View</li>
          </ol>
        </nav> 
    </div>
</div>
...
<!-- Start page content -->
    ...
    <table>
        ...
        <?php } ?>
                ...
                <form action="Owner.html" align="center">
