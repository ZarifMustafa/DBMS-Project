<html>
    <head>
    <title>Available Decorations</title></head>
    <body>
    <?php
...
$connection = oci_connect('HELLO', 'hello', 'localhost/XEPDB1');
    ...
    $query = "select * from hall natural join has natural join decorations where hall_id=:hallID";
    ...
    $tableHtml = '<table>
        ...
        while ($row = oci_fetch_assoc($statement)) {
            $tableHtml .= '<tr>';
            $tableHtml .= '<td style="text-align: left;">' . $row['THEME'] . '</td>';
            $tableHtml .= '<td style="text-align: left;">' . $row['DESCRIPTION'] . '</td>';
            $tableHtml .= '<td style="text-align: left;">' . $row['DEC_PRICE'] . '</td>';
            $tableHtml .= '<td>
                                <form action="payment.php" method="post">
                                    <input type="hidden" name="hall_id" value="' . $hallID . '">
                                    <input type="hidden" name="menu_id" value="' . $menuID . '">
                                    <input type="hidden" name="catering_id" value="' . $cateringID . '">
    ...
    <head>
        ...
        <title>Available Decorations</title>
        <style>
            table {
                width: 100%;
...
<div class="fables-header fables-after-overlay" style="background-image: url(assets/custom/images/index1bg.jpg);">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Available Decorations</h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <div class="container"> 
        <nav aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            ...
            <li class="breadcrumb-item active" aria-current="page">Available Decorations</li>
          </ol>
        </nav> 
    </div>
</div>
...
<!-- Start page content -->
        <h1>Available Decorations</h1><br><br>
