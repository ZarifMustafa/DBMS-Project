<html>
    ...
    $query_upcoming = "SELECT * FROM hall natural join books natural join owner WHERE (owner_id=:owner_id and booking_date > SYSDATE and lower(status)='booked')";
    ...
    $query_past = "SELECT * FROM hall natural join books natural join owner WHERE (owner_id=:owner_id and booking_date < SYSDATE and lower(status)='booked')";
    ...
    $query_cancelled = "SELECT * FROM hall natural join books natural join owner WHERE (owner_id=:owner_id and lower(status)='cancelled')";
