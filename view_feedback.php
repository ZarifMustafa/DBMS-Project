<html>
    <head>
    <title>Feedback for Hall</title></head>
    <body>
    <?php
    ...
    $query = "SELECT * FROM feedback_view";
...
<!-- Start Header -->
<div class="fables-header fables-after-overlay" style="background-image: url(assets/custom/images/FeedbackBg.jpg);">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Feedback for Hall</h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <div class="container"> 
        <nav aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            ...
            <li class="breadcrumb-item active" aria-current="page">Feedback for Hall</li>
          </ol>
        </nav> 
    </div>
</div>
        ...
        <?php if ($rows > 0) { ?>
            <?php foreach ($data as $row) { ?>
                <div class="box1">
                    ...
                    <p><?php echo str_replace(';', '<br>', $row['FEEDBACK DATE']); ?></p>
                    <p><?php echo str_replace(';', '<br>', $row['Description']); ?></p>
                </div>
            <?php } ?>
        <?php } else { ?>
