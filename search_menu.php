<html>
    <head>
    <title>Available Menus</title></head>
    <body>
    <?php
    ...
    $query = "select * from hall natural join provides natural join menu where hall_id=:hallID";
    ...
    $tableHtml = '<table>
        ...
        while ($row = oci_fetch_assoc($statement)) {
            $tableHtml .= '<tr>';
            $tableHtml .= '<td style="text-align: left;">' . $row['TYPE'] . '</td>';
            $tableHtml .= '<td style="text-align: left;">' . $row['M_PRICE'] . '</td>';
            $tableHtml .= '<td>
                                <form action="search_catering_service.php" method="post">
...
<div class="fables-header fables-after-overlay" style="background-image: url(assets/custom/images/index1bg.jpg);">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Available Menu</h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <div class="container"> 
        <nav aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            ...
            <li class="breadcrumb-item active" aria-current="page">Available Menu</li>
          </ol>
        </nav> 
    </div>
</div>
