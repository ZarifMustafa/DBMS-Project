<html>
    <head>
    <title>Available Catering Services</title></head>
    <body>
    <?php
    ...
    $query = "select * from hall natural join offers natural join catering_service where hall_id=:hallID";
    ...
    $tableHtml = '<table>
        ...
        while ($row = oci_fetch_assoc($statement)) {
            $tableHtml .= '<tr>';
            $tableHtml .= '<td style="text-align: left;">' . $row['CATERING_NAME'] . '</td>';
            $tableHtml .= '<td style="text-align: left;">' . $row['CATERING_PRICE'] . '</td>';
            $tableHtml .= '<td>
                                <form action="search_decoration.php" method="post">
                                    <input type="hidden" name="hall_id" value="' . $hallID . '">
                                    <input type="hidden" name="menu_id" value="' . $menuID . '">
                                    <input type="hidden" name="catering_id" value="' . $row['CATERING_ID'] . '">
...
<div class="fables-header fables-after-overlay" style="background-image: url(assets/custom/images/index1bg.jpg);">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Available Catering Services</h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <div class="container"> 
        <nav aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            ...
            <li class="breadcrumb-item active" aria-current="page">Available Catering Services</li>
          </ol>
        </nav> 
    </div>
</div>
...
<!-- Start page content -->
        <h1>Available Catering Services</h1><br><br>
