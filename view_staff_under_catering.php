<?php
    ...
    $query = "SELECT * FROM staff_under_catering_view";
...
<!DOCTYPE html>
        ...
        <head>
            ...
            <title>Staff under Catering Services</title>
    <style>
        body {
    ...
    <div class="container"> 
        <nav aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            ...
            <li class="breadcrumb-item"><a href="view_catering_under_hall.php" class="fables-second-text-color">Catering Services Under Hall</a></li>
            <li class="breadcrumb-item active" aria-current="page">Staff Under Catering Services</li>
          </ol>
        </nav> 
    </div>
</div>
...
<!-- Start page content -->
            <br><h1>Staff under Catering Services</h1><br><br>

    <div class="container1">
        <?php if ($rows > 0) { ?>
            <?php foreach ($data as $row) { ?>
                <div class="box1">
                    <h2 class="orange-h2"><?php echo $row['Catering Name']; ?></h2>
                    <p><?php echo str_replace(';', '<br>', $row['Staffs issued']); ?></p>
                </div>
            <?php } ?>
        <?php } else { ?>
