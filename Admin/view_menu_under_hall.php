<html>
    <head>
    <title>View Menu Under Hall</title></head>
    <body>
    <?php
    ...
    $query = "SELECT * FROM menu_under_hall_view";
...
<!-- Start Header -->
<div class="fables-header fables-after-overlay" style="background-image: url(assets/custom/images/index3bg.jpg);">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Menu Under Hall</h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <div class="container"> 
        <nav aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            ...
            <li class="breadcrumb-item"><a href="view_menu.html" class="fables-second-text-color">Menu</a></li>
            <li class="breadcrumb-item active" aria-current="page">Menu Under Hall</li>
          </ol>
        </nav> 
    </div>
</div>
        ...
        <?php if ($rows > 0) { ?>
            <?php foreach ($data as $row) { ?>
                <div class="box">
                    ...
                    <p><?php echo str_replace(';', '<br>', $row['Menu types available']); ?></p>
                </div>
            <?php } ?>
        <?php } else { ?>
