<html>
    <head>
    <title>View Catering Services Under Hall</title></head>
    <body>
    <?php
    ...
    $query = "SELECT * FROM catering_view";
...
<head>
    ...
    <title>Catering Services under Hall</title>
    <style>
        body {
...
<!-- Start Header -->
<div class="fables-header fables-after-overlay" style="background-image: url(assets/custom/images/index2bgcat.jpg);">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Catering Services Under Hall</h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <div class="container"> 
        <nav aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            ...
            <li class="breadcrumb-item active" aria-current="page">Catering Services Under Hall</li>
          </ol>
        </nav> 
    </div>
</div>
...
<!-- Start page content -->
    <h1>Catering Services under Hall</h1><br>
        ...
        <?php if ($rows > 0) { ?>
            <?php foreach ($data as $row) { ?>
                <div class="box1">
                    ...
                    <p><?php echo str_replace(';', '<br>', $row['Catering services available']); ?></p>
                </div>
            <?php } ?>
        <?php } else { ?>
