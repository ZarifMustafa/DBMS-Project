...
<div class="fables-header fables-after-overlay" style="background-image: url(assets/custom/images/index1bg.jpg);">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Hall Choice</h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <div class="container"> 
        <nav aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            ...
            <li class="breadcrumb-item active" aria-current="page">Hall Choice</li>
          </ol>
        </nav> 
    </div>
</div>
...
<div class="container">
        <div class="row my-4 my-lg-5">
            <div class="col-12 col-md-10 offset-md-1 col-lg-6 offset-lg-3 text-center">
                ...
                <p class="font-20 semi-font fables-main-text-color mt-4 mb-5">Choose a hall</p>

    <?php

    // Display the halls as selectable buttons
    while ($row = oci_fetch_assoc($statement)) {
        $hallId = $row['HALL_ID'];
        $hallName = $row['HALL_NAME'];
        //echo $hallId;

        echo '<form method="get" action="select_catering_services.php">';
        echo '<input type="hidden" name="hall_id" value="' . $hallId . '">';
        echo '<button class="btn btn-primary btn-lg btn-block" type="submit">' . $hallName . '</button>';
        echo '</form>';
    }
    ?>
            </div>
