<html>
    <head>
    <title>View Decorations</title></head>
    <body>
    <?php
        ...
        $query = "SELECT * FROM decoration_view";
...
<div class="fables-header fables-after-overlay" style="background-image: url(assets/custom/images/index2bgdec.jpg);">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Decorations</h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <div class="container"> 
        <nav aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            ...
            <li class="breadcrumb-item active" aria-current="page">Decorations</li>
          </ol>
        </nav> 
    </div>
</div>
...
<!-- Start page content -->
            <h1>Available Decorations</h1><br>

            <div class="container1">
                <?php while ($row = oci_fetch_assoc($statement)) { ?>
                    <div class="item">
                        <h2 class="orange-h2"><?php echo $row['THEME']; ?></h2>
                        <h4 class="orange-h2"><?php echo $row['DECORATION NO']; ?></h4>
                        <p><?php echo 'Price: ' . $row['PRICE']; ?></p>
                        <p><?php echo $row['DESCRIPTION']; ?></p>
                    </div>
                <?php } ?>
            </div><br><br>
                <form action="view_decoration_under_hall.php" method="POST" align="center">
                    <input type="hidden" name="hall_id" value="' . $hallId . '">
                    <input class="BH" type="submit" value="Proceed">
                </form>
                <form action="cat_ser_dec_list.html" align="center">
