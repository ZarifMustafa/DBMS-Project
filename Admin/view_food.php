...
<!-- Start page content -->
            <h1>Available Foods</h1><br>

            <div class="container1">
                <?php while ($row = oci_fetch_assoc($statement)) { ?>
                    <div class="item">
                        <h2>
                            <span class="menu-type orange-h2"><?php echo $row['Food Name']; ?></span>
                        </h2><br><br><br>
                        <p><?php echo str_replace(';', '<br><br>', $row['Food Description']); ?></p><br>
                    </div>
                <?php } ?>
            </div>
