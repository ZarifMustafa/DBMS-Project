<html>
    <head>
    <title>View Decoration Under Hall</title></head>
    <body>
    <?php
    ...
    $query = "SELECT * FROM decoration_under_hall_view";
    ...
    // Free statement and close the database connection
...
<head>
    ...
    <title>Decorations under Hall</title>
    <style>
        body {
...
<!-- Start Header -->
<div class="fables-header fables-after-overlay" style="background-image: url(assets/custom/images/index2bgdec.jpg);">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Decorations Under Hall</h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <div class="container"> 
        <nav aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            ...
            <li class="breadcrumb-item"><a href="cat_ser_dec_list.html" class="fables-second-text-color">Catering Services and Decorations</a></li>
            <li class="breadcrumb-item"><a href="view_decoration.php" class="fables-second-text-color">Decorations</a></li>
            <li class="breadcrumb-item active" aria-current="page">Decorations Under Hall</li>
          </ol>
        </nav> 
    </div>
</div>
...
<!-- Start page content -->
    <h1>Decorations under Hall</h1><br>

    <div class="container1">
        <?php if ($rows > 0) { ?>
            <?php foreach ($data as $row) { ?>
                <div class="box">
                    <h2 class="orange-h2"><?php echo $row['Hall Name']; ?></h2>
                    <p><?php echo str_replace(';', '<br>', $row['Decorations available']); ?></p>
                </div>
            <?php } ?>
        <?php } else { ?>
