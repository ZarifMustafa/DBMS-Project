...
<div class="fables-header fables-after-overlay" style="background-image: url(assets/custom/images/index3bg.jpg);">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Menu</h2>
    </div>
</div>  
<!-- /End Header -->
...
<!-- Start page content -->
            ...
            <div class="container1">
                <?php while ($row = oci_fetch_assoc($statement)) { ?>
                    <div class="item">
                        <h2>
                            <span class="menu-type orange-h2"><?php echo $row['Menu Type']; ?></span>
                            <span class="price"><?php echo 'Price: ' . $row['PRICE']; ?></span>
                        </h2><br><br><br>
                        <p><?php echo str_replace(';', '<br><br>', $row['FOOD LIST']); ?></p><br>
                    </div>
                <?php } ?>
            </div>
