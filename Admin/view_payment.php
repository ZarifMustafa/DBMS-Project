...
$query = "SELECT * FROM payment_view";
...
<div class="fables-header fables-after-overlay" style="background-image: url(assets/custom/images/PaymentBg.jpg);">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Payment View</h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <table>
        ...
        <?php foreach ($data as $row) { ?>
            <tr>
                ...
                <td><?php echo $row['PAYMENT NO']; ?></td>
                <td><?php echo $row['Customer Name']; ?></td>
                <td><?php echo $row['Hall Name']; ?></td>
                <td><?php echo $row['Booking Slot']; ?></td>
