...
<div class="container">
    ...
    // Display the menus as selectable buttons
    while ($row = oci_fetch_assoc($statement)) {
        $menuId = $row['MENU_ID'];
        $menuName = $row['TYPE'];
        //echo $menuId;

        echo '<form method="get" action="select_food.php">';
        echo '<input type="hidden" name="menu_id" value="' . $menuId . '">';
        echo '<button class="btn btn-primary btn-lg btn-block" type="submit">' . $menuName . '</button>';
        echo '</form>';
    }
    ?>
            </div>
