<?php
    ...
    $query = "SELECT * FROM staff_doing_decorations_view";
...
<!DOCTYPE html>
        ...
        <head>
            ...
            <title>Staff doing Decoration</title>
    <style>
        body {
...
<div class="fables-header fables-after-overlay" style="background-image: url(assets/custom/images/index2bgdec.jpg);">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Staff Under Catering Services</h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <div class="container"> 
        <nav aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            ...
            <li class="breadcrumb-item"><a href="view_decoration.php" class="fables-second-text-color">Available Decorations</a></li>
            <li class="breadcrumb-item"><a href="view_decoration_under_hall.php" class="fables-second-text-color">Decorations Under Hall</a></li>
            <li class="breadcrumb-item active" aria-current="page">Staff Under Decorations</li>
          </ol>
        </nav> 
    </div>
</div>
...
<!-- Start page content -->
            <br><h1>Staff doing Decoration</h1><br><br>

    <div class="container1">
        <?php if ($rows > 0) { ?>
            <?php foreach ($data as $row) { ?>
                <div class="box1">
                    <h2 class="orange-h2"><?php echo $row['DECORATION ID NO']; ?></h2>
                    <p><?php echo str_replace(';', '<br>', $row['Staffs\' decoration']); ?></p>
                </div>
            <?php } ?>
        <?php } else { ?>
